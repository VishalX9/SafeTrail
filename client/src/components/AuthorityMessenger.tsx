...
export function AuthorityMessenger() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (selectedAuthorities.length === 0) {
      alert("Please select at least one authority to contact");
      return;
    }
    ...
    // Show confirmation
    alert(`📨 Message Sent Successfully!\n\n📍 To: ${selectedAuthorityNames.join(', ')}\n📋 Subject: ${message.subject}\n⚡ Priority: ${message.priority.toUpperCase()}\n📍 Location: ${newMessage.location}\n\n✅ Authorities will respond based on priority level.\n🕐 Expected response: 10-45 minutes`);
